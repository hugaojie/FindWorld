...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">发现</a>
					...
					.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < curObj.length; i++) {
								...
								$('#mainDiv').append($(div));
								var img = $("<img class='card-img-top' src='"+curObj[i].contentPicture+"' alt='Card image cap'>");
								div.append(img);
								var div2 = $("<div class='card-body'> <h5 class='card-title'> <strong>"
										...
										+ "</p> <a href='#' class='btn btn-primary'>阅读更多 &rarr;</a></div>");
								div.append(div2);
								var div3 = $("<div class='card-footer text-muted'> 发布于 "
